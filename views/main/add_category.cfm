...
<form method="post" action="<cfoutput>#buildURL(action="main.add_category_action")#</cfoutput>">
	 <input type="hidden" name="catcode" class="form-control" value="<cfoutput>#rc.id#</cfoutput>" >

	<div class="col-sm-6 mb-4">
    <label for="category">Category Name</label>
	</div>
    <div class="col-sm-6 mb-4">
     <input type="text" name="cat_name" class="form-control" value="<cfoutput>#rc.cat#</cfoutput>" placeholder="Enter Category Name" required="">
    </div>
	 <div class="col-sm-6 mb-4">
              ...
              <tbody>
                  <cfoutput query="#rc.show#">
                      ...
                      <td>#cat_name#</td>
 					  ...
 					  <td><a href="#buildURL(action="main.add_category",querystring="id=#catcode#")#" class="btn btn-primary btn-sm">Edit</a></td>
 					  <td><a href="#buildURL(action="main.delete_category",querystring="id=#catcode#")#" class="btn btn-danger btn-sm">Delete</a></td>
                      </tr>
                      </cfoutput>
